            ...
            <div id="hide" class="hide">
                <div class="frame-mess">
                    <div class="frame-hapo">
                        <p>HapoLearn</p>
                        <img onclick="hide()"
                            src="{{asset('images/close-mess.png')}}">
                    </div>
                    <div class="hello">
        ...
        <div class="tutorial-hapo">
            <div class="container-card">
                <div class="row">
                    <div class="col-xl-4 col-md-4 d-flex
                        ...
                        <div class="card-hapo">
                            <img src="{{asset('images/hjs.PNG')}}" class="card-img-top"
                                alt="hjs" />
                            <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-4 d-flex
                        justify-content-center">
                        <div class="card-hapo">
                            <img src="{{asset('images/php.PNG')}}" class="card-img-top"
                                alt="php" />
                            <div class="card-body">
            ...
            <div class="view-courses">
                <p class="text-center">View All Our Courses <img class="arrow"
                        src="{{asset('images/arrow.png')}}" alt="arrow"></p>
            </div>
        </div>
        ...
        <div class="why-hapo" style="background-image:
            ...
            <div class="container-fuild">
                ...
                <div class="laptop"><img
                        src="{{asset('images/laptop.PNG')}}" alt="laptp"></div>
                ...
                <div class="info-laptop">
                    ...
                    <div class="laptop-phone"><img
                            src="{{asset('images/lap-ipone.png')}}"
                            alt="laptop-ipone">
                    </div>
                </div>
            </div>
                    ...
                    <div class="feelback-card">
                        ...
                        <div class="user">
                            <div class="image-user">
                                <img
                                    src="{{asset('images/meo.PNG')}}" alt="avatar">
                            </div>
                            <div class="user-info">
